...
The system comes with a pre-seeded test account for immediate use:
...
*Note: The Staff account can be created through the registration endpoint or user management interface.*
...
4. **Run Database Migrations**
   ...
   This will create the database and seed it with the admin test account.
